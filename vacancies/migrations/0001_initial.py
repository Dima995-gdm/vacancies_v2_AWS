    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, default='company_images/default.png', upload_to='company_images', verbose_name='Логотип')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('NOT_LOOKING', 'Не ищу работу'), ('CONSIDER', 'Рассматриваю предложения'), ('LOOKING', 'Ищу работу')], max_length=24, verbose_name='Готовность к работе')),
                ('salary', models.IntegerField(verbose_name='Ожидаемое вознаграждение')),
                ('grade', models.CharField(choices=[('TRAINEE', 'Стажер'), ('JUNIOR', 'Джуниор'), ('MIDDLE', 'Миддл'), ('SENIOR', 'Сеньор'), ('LID', 'Лид')], max_length=24, verbose_name='Квалификация')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('written_phone', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region='RU', unique=True, verbose_name='Телефон')),
